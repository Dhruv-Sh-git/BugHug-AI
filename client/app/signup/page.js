    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="text-center mb-7">
          ...
          <h1 className="text-2xl font-semibold text-[var(--ink)]">Create your account</h1>
          <p className="text-sm text-muted mt-1">Start with a calm, helpful assistant</p>
        </div>
        ...
        <div className="bg-white/90 border border-[var(--line)] rounded-2xl p-6 shadow-xl">
          ...
          <div className="space-y-4">
            <div>
              <label className="text-xs font-medium text-muted mb-1.5">Name</label>
              <input
                type="text"
            ...
            <div>
              <label className="text-xs font-medium text-muted mb-1.5">Password</label>
              <input
                type="password"
                placeholder="••••••••"
                className="w-full bg-white border border-[var(--line)] text-[var(--ink)] placeholder:text-[#9aa3b8] rounded-lg px-3.5 py-2.5 text-sm outline-none focus:border-[#8db0ff] focus:ring-2 focus:ring-[#e3ecff] transition-all"
        ...
        <p className="text-center text-sm text-muted mt-5">
          ...
          <Link href="/login" className="text-[var(--accent)] hover:brightness-105 font-semibold transition-colors">
            Sign in
          </Link>
        </p>
      </div>
